 ...
 * @returns {number} selected option (or -1 if invalid)
 */
 ...
 * Prompts for an id and prints details to console.
...
/**
 * Handle updating photo details via prompt then persistence.
 * @returns {Promise<void>}
 */
...
/**
 * Handle album photo list CSV generation and print result.
 * @returns {Promise<void>}
 */
...
/**
 * Handle adding a tag to a photo via prompt and persistence.
 * @returns {Promise<void>}
 */
...
/**
 * Main program loop that shows the menu and dispatches actions.
 * @returns {Promise<void>}
 */
async function main() {
